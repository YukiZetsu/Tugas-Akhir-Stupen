            ...
            <div className="flex items-center lg:order-2">
              {token && userInfo ? (
                ...
                <>
                  ...
                  <Link
                    to={"/register"}
                    className="text-white bg-red-700 hover:bg-indigo-800 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-indigo-600 dark:hover:bg-indigo-700 focus:outline-none dark:focus:ring-indigo-800"
                  >
                    Bergabung
                  </Link>
                </>
